# Feature Specification: NoType V2 - Configurable Voice Tool

**Feature Branch**: `002-configurable-voice-tool`
...
- **FR-010**: The system MUST include personal dictionary entries as contextual hints in the LLM polish prompt to improve recognition accuracy.
...
- **Q**: 个人词典如何生效？ → **A**: 在 LLM 润色 prompt 中把词典条目作为上下文 hint。
...
- Personal dictionary entries are included as contextual hints in the LLM polish prompt.
